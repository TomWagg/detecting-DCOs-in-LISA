...
\begin{table*}[htb]
    ...
    \begin{tabular}{cl|cccc|cccc}
        ...
        F & Case BB Unstable + Optimistic CE & \confinv{321}{18}{18} & \confinv{154}{12}{13} & \confinv{148}{12}{13} & \confinv{18}{4}{4} & \confinv{484}{22}{22} & \confinv{240}{16}{15} & \confinv{217}{15}{15} & \confinv{27}{5}{6}\\
        G & CE efficiency $\alpha = 0.1$ & \confinv{40}{6}{7} & \confinv{28}{5}{5} & \confinv{2}{1}{2} & \confinv{10}{3}{3} & \confinv{64}{8}{8} & \confinv{44}{7}{7} & \confinv{3}{1}{2} & \confinv{17}{4}{4}\\
        ...
        J & CE efficiency $\alpha = 10.0$ & \confinv{78}{9}{9} & \confinv{27}{5}{5} & \confinv{16}{4}{4} & \confinv{35}{6}{6} & \confinv{126}{11}{11} & \confinv{42}{6}{7} & \confinv{27}{6}{5} & \confinv{57}{7}{8}\\
