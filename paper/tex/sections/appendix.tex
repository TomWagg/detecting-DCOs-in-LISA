...
\begin{table}[htb]
    ...
    \begin{tabular}{cl}
        ...
        \modCaseBB & Exclude Case BB mass transfer is always unstable \\
        \modCaseBBOpt & Case BB mass transfer always unstable + Optimistic CE \\
        \hline
...
\begin{table*}[htb]
    ...
    \begin{tabular}{cl|cccc|cccc}
        ...
        F & Unstable Case BB + K & \boldconfinv{320.9}{17.9}{18.1} & \boldconfinv{154.3}{12.3}{12.7} & \boldconfinv{148.4}{12.4}{12.6} & \confinv{18.2}{4.2}{3.8} & \boldconfinv{483.7}{21.7}{22.3} & \boldconfinv{239.5}{15.5}{15.5} & \confinv{216.8}{14.8}{15.2} & \confinv{27.4}{5.4}{5.6}\\
