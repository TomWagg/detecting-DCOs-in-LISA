...
\begin{align}
    M_{\rm SF, MW} &= (6.1 \pm 1.1) \times 10^{10} \unit{M_{\odot}} \cdot \frac{0.384 \unit{M_{\odot}}}{0.257 \unit{M_{\odot}}}, \nonumber \\
    &= (9.1 \pm 1.1) \times 10^{10} \unit{M_{\odot}},
\end{align}
...
\begin{align}
    N_{\rm detect} &= f_{\rm detect} \cdot 9.1 \times 10^{10} \unit{M_{\odot}} \nonumber \\
...
\begin{figure}
    \centering
    \includegraphics[height=0.3\textheight]{formation_channels_BHBH.pdf}
    \includegraphics[height=0.3\textheight]{formation_channels_BHNS.pdf}
    \includegraphics[height=0.3\textheight]{formation_channels_NSNS.pdf}
