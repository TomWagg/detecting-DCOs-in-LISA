...
\todo{Discuss $\alpha_{\rm CE}$ changes: It seems that alpha=1 is a sweet spot for BHBH and BHNS (they seem to follow the same trend) whilst NSNS has a very different pattern -- not really sure what's happening here}
