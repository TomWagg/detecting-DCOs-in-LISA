...
%
To determine the detectability of sources with LISA we use the LEGWORK package (Wagg et al.\ in prep), that was specifically developed for this purpose and is publicly available. 
%
