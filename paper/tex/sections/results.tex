In this section we present our main results for the detectable LISA DCO population. We find that, for our fiducial model, a four 4-year LISA mission will detect \confinv{30.6}{20.5}{51.1} BHBHs, \confinv{26.4}{17.3}{48.5} BHNSs and \confinv{7.1}{4.8}{10.8} NSNSs where the error bars represent the 90\% confidence interval. We first show the distribution of the sources on the sensitivity curve in Section~\ref{sec:dcos_on_sc}, before exploring the variations in the detection rate over different physics variations in Section~\ref{sec:detection_rate_analysis} and analysing the parameter distributions for detectable sources in the fiducial model in Section~\ref{sec:fiducial_distributions}.
...
We find that for our fiducial model, a 4-year LISA mission will detect \confinv{30.6}{20.5}{51.1} BHBHs, \confinv{26.4}{17.3}{48.5} BHNSs and \confinv{7.1}{4.8}{10.8} NSNSs, where the error bars represent the 90\% confidence interval. Increasing to a 10-year LISA mission length changes the number of detections to \confinv{50.6}{29.2}{63.3}, \confinv{46.2}{25.7}{99.3} and \confinv{12.1}{6.9}{13.5} respectively. In Figure~\ref{fig:detection_rates}, we show the expected number of LISA detections for each model variation and discuss the prominent trends in the following sections. We show the rates and uncertainties plotted in this figure in Table~\ref{tab:detection_rates}.
...
\todo{This will be about how the shapes of the parameter distributions change for the different model variations. I won't detail every variation but I'll point out anything that stands out and leave the rest in the appendix plots.}