...
In our fiducial model, approximately two thirds of detectable BHBHs are formed through the `only stable mass transfer' channel \citep{vandenHeuvel+2017}, whilst the remaining third are primarly formed through the `classic' channel \citep{Bhattacharya+1991}. Detectable BHNSs follow an inverse pattern, such that around two thirds are formed through the `classic' channel and the rest are mainly formed through only stable mass transfer.
