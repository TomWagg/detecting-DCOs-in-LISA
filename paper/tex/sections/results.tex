...
\begin{figure}[tb]
    \centering
    \includegraphics[width=\columnwidth]{fig4_1_detectable_distance_distribution_4yr.pdf}
    \includegraphics[width=\columnwidth]{fig4_2_galaxy_density_distribution.png}
