...
\todo{@Selma suggests we return to this section. NSs do \textbf{NOT} receive stronger natal kicks in our simulations since most are formed through ECSN e.g. and have 30km/s instead of 265km/s. }
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=\columnwidth]{fig5_chirp_mass_uncertainty_all.pdf}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=\columnwidth]{fig6_angular_resolution_all.pdf}
