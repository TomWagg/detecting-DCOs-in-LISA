...
%         \hline
%         \multirow{2}{*}{Threshold} & \multicolumn{3}{c}{Individually detectable harmonics} \\ \cline{2-4}
%         & 0 & 1 & 2+ \\
%         \hline
%         $\mathrm{SNR} > 7$ & 18\%  & 67\% & 15\% \\
%         $\mathrm{SNR} > 3$ &  8\%  & 54\% & 38\% \\
%         $\mathrm{SNR} > 1$ &  4\%  & 30\% & 66\% \\
%     \end{tabularx}
%     \caption{Percentage of systems with individual harmonics above different SNR thresholds.}
%     \label{tab:test}
% \end{table}
...
%\subsection{Progenitors and formation channels}\label{sec:progenitors_and_formation}
%Our simulations also provide information about the properties of the progenitor systems.  In Figure~\ref{fig:progenitor_properties}, we show the distribution of initial primary masses and initial mass ratios of the progenitors of the LISA detectable DCOs in the top and bottom panel respectively. 

%We see that the vast majority of NSNSs are formed with progenitor masses below $20 \unit{M_{\rm \odot}}$ and none are formed with masses greater than $30 \unit{M_{\rm \odot}}$. In contrast, the primary stars in systems that form  BHNSs and BHBHs have very primary progenitor masses that peak around 50\Msun and 80\Msun. We note that the evolution of such massive progenitor stars is poorly understood which is reason for substantial uncertainties in our final predictions which are unfortunately still hard to quantify at present. 

%Concerning, the mass ratios we see that, in our fiducial simulations, NSNS tend to form from systems with initial mass ratios close to unity. BHBH and BHNS systems tend to form from systems with initial mass ratios of around 0.3, similar to the trend shown in the final mass final for the DCOs (c.f.\ Fig.~\ref{fig:fiducial_pdf_distributions}c). 



%\begin{figure}[htb]
%    \centering
%    \includegraphics[width=\columnwidth]{fig5_progenitor_distributions.pdf}
%    \caption{As Fig.~\ref{fig:fiducial_pdf_distributions}, but for the initial primary mass (top) and initial mass ratio (bottom). Note that the y-axis is log-scaled for the initial primary mass. \href{https://github.com/TomWagg/detecting-DCOs-in-LISA/blob/main/paper/figures/fig5_progenitor_distributions.pdf}{\faFileImage} \href{https://github.com/TomWagg/detecting-DCOs-in-LISA/blob/main/paper/figure_notebooks/fiducial.ipynb}{\faBook}.}
